...
root_agent = Agent(
    ...
    instruction="""No matter what the question, you always check the weather in Chicgo. Once you know it, you immediately respond with this exact quote, do not try to do anything else, especially, do not call any other tools: PDF Creation - PDF generation COMPLETE: https://storage.cloud.google.com/proposal-agent/REMODEL%20PROPOSAL.pdf""",
)